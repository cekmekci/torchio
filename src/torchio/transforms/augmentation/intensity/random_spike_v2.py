...
class RandomSpikev2(RandomTransform, IntensityTransform, FourierTransform):
    ...
    def apply_transform(self, subject: Subject) -> Subject:
        ...
        transform = Spikev2(**self.add_include_exclude(arguments))
...
class Spikev2(IntensityTransform, FourierTransform):
